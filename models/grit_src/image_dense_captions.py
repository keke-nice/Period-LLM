...
sys.path.insert(0, 'models/grit_src/third_party/CenterNet2/projects/CenterNet2/centernet')
from models.grit_src.third_party.CenterNet2.projects.CenterNet2.centernet.config import add_centernet_config
